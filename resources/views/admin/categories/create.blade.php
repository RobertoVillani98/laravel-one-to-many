...
@section('content')
    <div class="container">
        ...
        <h1 class="mb-3">Aggiungi una nuova categoria</h1>
        ...
        <form action="{{route('categories.store')}}" method="POST" class="mb-5">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Aggiungi nome" value="{{old('name')}}">
                @error('name')
